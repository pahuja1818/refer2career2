(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function dfH(module, __webpack_exports__, __webpack_require__) {
      ...
      var NotFoundComponent = /*#__PURE__*/function () {
        function NotFoundComponent() {
          ...
          this.message = 'No matches with Given Criteria';
    ...
    /***/
    function m3E(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EmployerSigninComponent", function () {
        return EmployerSigninComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_employer_signin_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./employer-signin.component.html */
      "0xYs");
      /* harmony import */


      var _employer_signin_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./employer-signin.component.scss */
      "MOns");
      /* harmony import */
      ...
      var EmployerSigninComponent = /*#__PURE__*/function () {
        function EmployerSigninComponent(modalRef, authService, router, toast, modalService, location) {
          _classCallCheck(this, EmployerSigninComponent);
        ...
        _createClass(EmployerSigninComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
          ...
          value: function resendOTP() {
            ...
            this.authService.getOTP({
              ...
              if (data.data === true) {
                _this2.toast.showToast('Passcode Sent Successfully!');
                ...
                Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
                  ...
                  _this2.timer = counter;
                });
                _this2.isServiceRunning = false;
              }
            });
          }
        }, {
            ...
            if (this.isForgotPassOTP) {
              ...
              this.authService.verify(data).subscribe(function (res) {
                if (res.data === true) {
                  ...
                  _this4.isResetPassword = true;
                } else {
                  _this4.isOTPCorrect = false;
                }
              ...
              this.authService.getOTP({
                ...
                if (data.data === true) {
                  ...
                  Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
                    ...
                    _this5.timer = counter;
                  });
                  _this5.isForgotPassOTP = true;
                }
            ...
            if (this.resetPassword.value) {
              ...
              this.authService.update(dbopeartion).then(function (data) {
                if (data.data === true) {
                  ...
                  _this6.toast.showToast('Password Reseted!');

                  _this6.isLogin = true;
                  _this6.isServiceRunning = false;
                }
              });
            }
          }
      ...
      EmployerSigninComponent.ctorParameters = function () {
        return [{
      ...
      EmployerSigninComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    function sq2(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "::ng-deep .mat-form-field-flex > .mat-form-field-infix {\n  padding: 0.9em 0px !important;\n}\n\n::ng-deep .mat-form-field-label-wrapper {\n  top: -1.3em;\n  font-size: 15px;\n}\n\n::ng-deep .mat-form-field-appearance-outline.mat-form-field-can-float.mat-form-field-should-float .mat-form-field-label {\n  transform: translateY(-1.1em) scale(0.75);\n}\n\n::ng-deep .cdk-overlay-container {\n  z-index: 1200 !important;\n}\n\n.active-menu {\n  color: blueviolet;\n  border-bottom: 2px solid blueviolet;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    /***/
    function Mdj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(AddJobPostComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.filteredSkills = this.skillName.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (value) {
              return _this7._filterSkills(value);
            }));
          ...
          value: function addFieldValueToSkillArray() {
            ...
            if (this.skillName.value) {
              if (!this.skillsArray.find(function (data) {
                return data.skillName === _this8.skillName.value;
              })) {
            ...
            if (this.questionsArray.length > 0) {
              this.questionsArray.forEach(function (question, index) {
                if (question.question === '') {
                  _this9.toastService.showToast('Please enter question');

                  return;
                }

                if (index === _this9.questionsArray.length - 1) {
                  _this9.addPost();
                }
              });
            } else {
                ...
                if (this.jobPostForm.valid) {
                  ...
                  if (!this.jobPost) {
                    this.jobPostService.addJobPost(post).subscribe(function (data) {
                      if (data.data === true) {
                        _this10.toastService.showToast('Job Post Added Successfully !');
                      }
                      ...
                      _this10.jobPostService.getPosts();
                    });
                  } else {
                    post._id = this.jobPost._id;
                    this.jobPostService.updateJobPost(post).subscribe(function (data) {
                      if (data.data === true) {
                        _this10.toastService.showToast('Job Post Updated Successfully !');
                      }

                      _this10.jobPostService.post = undefined;
                      _this10.isServiceRunning = false;

                      _this10.modalService.hide();
          ...
          value: function deletePost() {
            ...
            this.jobPostService.deleteJobPost({
              ...
              if (data.data === true) {
                _this11.toastService.showToast('Job post deleted successully!');
              }

              _this11.jobPostService.post = undefined;
              _this11.isServiceRunning = false;

              _this11.modalService.hide();

              window.history.back();
            }, function (err) {
              return _this11.isServiceRunning = false;
            });
          }
        }, {
          key: "delete",
        ...
        _createClass(AllJobPostsComponent, [{
          ...
          value: function getMyApplication() {
            ...
            this.authService.find(db).subscribe(function (data) {
              if (data.data) {
                _this12.allMyApplications = data.data;

                _this12.checkJobPosts();
              }
            });
          }
        }, {
          ...
          value: function checkJobPosts() {
            ...
            this.allJobPost.forEach(function (post) {
              if (_this13.allMyApplications.find(function (data) {
          ...
          value: function ngOnInit() {
            ...
            this.authService.find(db).subscribe(function (data) {
              if (data.data.length > 0) {
                _this14.filteredJobPosts = data.data;
                _this14.allJobPost = data.data;

                _this14.getMyApplication();

                _this14.sortByDate();

                _this14.isServiceRunning = false;
              }
            });
            var dbOpeartion = {
              collection: 'jobposts',
            ...
            this.authService.find(dbOpeartion).subscribe(function (data) {
              if (data.data.length > 0) {
                data.data.forEach(function (ele) {
                  _this14.allLocations.add(ele.jobPost.location);
                });
              }
            });
          }
          ...
          value: function filterJobPosts() {
            ...
            this.allJobPost.forEach(function (jobPost, index) {
              if (jobPost.jobPost.title.toLowerCase().includes(search)) {
                _this15.filteredJobPosts.push(JSON.stringify(jobPost));
              }
              ...
              if (_this15.allJobPost.length === index + 1) {
                var arr = _toConsumableArray(new Set(_this15.filteredJobPosts));

                _this15.filteredJobPosts = [];
                arr.forEach(function (data) {
                  _this15.filteredJobPosts.push(JSON.parse(data));
                });
              }
            });
          }
          ...
          value: function refineJobs() {
            ...
            this.authService.find(dbOpeartion).subscribe(function (data) {
              if (data.data) {
                _this16.filteredJobPosts = data.data;
                _this16.allJobPost = data.data;

                _this16.checkJobPosts();

                _this16.refineInitial.partTime = _this16.refine.partTime, _this16.refineInitial.fullTime = _this16.refine.fullTime, _this16.refineInitial.jobs = _this16.refine.jobs, _this16.refineInitial.internships = _this16.refine.internships, _this16.refineInitial.remote = _this16.refine.remote, _this16.refineInitial.minExp = _this16.refine.minExp, _this16.refineInitial.location = _this16.refine.location;

                if (!_this16.isScreenBig) {
                  _this16.refineJobsDropDown = false;
                }

                _this16.filterJobPosts();

                _this16.sortByDate();

                _this16.isServiceRunning = false;
              }
            });
          }
        }]);
        ...
        _createClass(ViewProfileComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (params) {
              if (params.id) {
                _this17.userId = params.id; // this.getDetails();
          ...
          value: function getUser() {
            ...
            this.authService.find({
              ...
              if (data.data.length > 0) {
                _this18.user = data.data[0];

                _this18.setBasicInfo();

                if (_this18.user.cvHead) {
                  _this18.cvHeadLine = _this18.user.cvHead;
                }

                _this18.educationArray = _this18.user.education ? _this18.user.education : [];
                _this18.workExpArray = _this18.user.workExperience ? _this18.user.workExperience : [];
                _this18.skillsArray = _this18.user.skills ? _this18.user.skills : [];
                _this18.isServiceRunning = false;
              } else {
                _this18.authService.find({
          ...
          value: function getCurrentUser() {
            ...
            if (window.localStorage.getItem('id')) {
              this.getDetails({
                ...
                _this20.currentUser.next(data.data);
              });
            }
          }
        }, {
        ...
        _createClass(ManageApplicantsComponent, [{
          ...
          value: function getAllJobs() {
            ...
            this.dbService.find(dbOperation).subscribe(function (data) {
              if (data.data.length > 0) {
                _this21.allPosts = data.data;

                _this21.allPosts.sort(function (a, b) {
    ...
    /***/
    function MOns(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function PCNd(module, __webpack_exports__, __webpack_require__) {
      ...
      var _login_signin_employer_signin_employer_signin_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./../login/signin/employer-signin/employer-signin.component */
      "3m3E");
      /* harmony import */


      var _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./components/not-found/not-found.component */
      "0dfH");
      /* harmony import */


      var _components_applications_applications_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./components/applications/applications.component */
      "iwS4");
      /* harmony import */


      var _components_manage_applicants_manage_applicants_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./components/manage-applicants/manage-applicants.component */
      "K5Im");
      /* harmony import */


      var _components_add_job_post_add_job_post_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var _angular_cdk_table__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! @angular/cdk/table */
      "f6nW");
      /* harmony import */


      var _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! @angular/cdk/tree */
      "FvrZ");
      /* harmony import */
      ...
      var _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      ...
      var _angular_material_menu__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
      ...
      var _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(
      /*! @angular/material/sidenav */
      "XhcP");
      /* harmony import */


      var _angular_material_slider__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
      ...
      var _angular_material_sort__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(
      ...
      var _angular_material_tabs__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(
      /*! @angular/material/tabs */
      "wZkO");
      /* harmony import */


      var _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(
      /*! @angular/material/toolbar */
      "/t3+");
      /* harmony import */


      var _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(
      /*! @angular/material/tooltip */
      "Qu3c");
      /* harmony import */


      var _angular_material_tree__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(
      /*! @angular/material/tree */
      "8yBR");
      /* harmony import */


      var _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(
      /*! @angular/cdk/overlay */
      "rDax");
      /* harmony import */


      var _ionic_angular__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(
      /*! @ionic/angular */
      "TEn/");
      /* harmony import */


      var _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(
      /*! @ionic-native/splash-screen/ngx */
      "54vc");
      /* harmony import */


      var _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(
      /*! @ionic-native/status-bar/ngx */
      "VYYF");
      /* harmony import */


      var ng_otp_input__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(
      /*! ng-otp-input */
      "9OaD");
      /* harmony import */


      var ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(
      /*! ngx-bootstrap/alert */
      "psEu");
      /* harmony import */


      var ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(
      /*! ngx-bootstrap/datepicker */
      "hzby");
      /* harmony import */


      var _components_add_job_post_job_details_job_details_component__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(
      /*! ./components/add-job-post/job-details/job-details.component */
      "shd7");
      /* harmony import */


      var _components_spinner_component_spinner_component_component__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(
      /*! ./components/spinner-component/spinner-component.component */
      "eDag");
      /* harmony import */


      var _components_all_job_posts_all_job_posts_component__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(
      /*! ./components/all-job-posts/all-job-posts.component */
      "Fg4b");
      /* harmony import */


      var _login_signin_signin_component__WEBPACK_IMPORTED_MODULE_64__ = __webpack_require__(
      /*! ../login/signin/signin.component */
      "WTty");
      /* harmony import */


      var _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_65__ = __webpack_require__(
      /*! @ng-select/ng-select */
      "ZOsW");
      /* harmony import */


      var ngx_bootstrap_collapse__WEBPACK_IMPORTED_MODULE_66__ = __webpack_require__(
      /*! ngx-bootstrap/collapse */
      "+Cnu");
      /* harmony import */


      var _components_nav_bar_content_nav_bar_content_component__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(
      /*! ./components/nav-bar-content/nav-bar-content.component */
      "Xsf5");
      /* harmony import */


      var _components_recent_jobs_recent_jobs_component__WEBPACK_IMPORTED_MODULE_68__ = __webpack_require__(
      ...
      SharedModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_7__["NgModule"])({
        declarations: [_components_spinner_component_spinner_component_component__WEBPACK_IMPORTED_MODULE_62__["SpinnerComponentComponent"], _components_add_job_post_add_job_post_component__WEBPACK_IMPORTED_MODULE_6__["AddJobPostComponent"], _components_add_job_post_job_details_job_details_component__WEBPACK_IMPORTED_MODULE_61__["JobDetailsComponent"], _components_all_job_posts_all_job_posts_component__WEBPACK_IMPORTED_MODULE_63__["AllJobPostsComponent"], _components_manage_applicants_manage_applicants_component__WEBPACK_IMPORTED_MODULE_5__["ManageApplicantsComponent"], _components_applications_applications_component__WEBPACK_IMPORTED_MODULE_4__["ApplicationsComponent"], _login_signin_signin_component__WEBPACK_IMPORTED_MODULE_64__["SigninComponent"], _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_3__["NotFoundComponent"], _login_signin_employer_signin_employer_signin_component__WEBPACK_IMPORTED_MODULE_2__["EmployerSigninComponent"], _components_view_profile_view_profile_component__WEBPACK_IMPORTED_MODULE_1__["ViewProfileComponent"], _components_nav_bar_content_nav_bar_content_component__WEBPACK_IMPORTED_MODULE_67__["NavBarContentComponent"], _components_recent_jobs_recent_jobs_component__WEBPACK_IMPORTED_MODULE_68__["RecentJobsComponent"]],
        entryComponents: [_components_add_job_post_add_job_post_component__WEBPACK_IMPORTED_MODULE_6__["AddJobPostComponent"], _components_manage_applicants_manage_applicants_component__WEBPACK_IMPORTED_MODULE_5__["ManageApplicantsComponent"]],
        imports: [_ng_select_ng_select__WEBPACK_IMPORTED_MODULE_65__["NgSelectModule"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["CommonModule"], ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_59__["AlertModule"].forRoot(), ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_60__["BsDatepickerModule"].forRoot(), ng_otp_input__WEBPACK_IMPORTED_MODULE_58__["NgOtpInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_41__["MatProgressSpinnerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_12__["MatFormFieldModule"], _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_13__["ClipboardModule"], _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_17__["CdkStepperModule"], _angular_cdk_table__WEBPACK_IMPORTED_MODULE_18__["CdkTableModule"], _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_19__["CdkTreeModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_14__["DragDropModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_20__["MatAutocompleteModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_21__["MatBadgeModule"], _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_22__["MatBottomSheetModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_23__["MatButtonModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_24__["MatButtonToggleModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_25__["MatCardModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_26__["MatCheckboxModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_27__["MatChipsModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_28__["MatStepperModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_29__["MatDatepickerModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_30__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_31__["MatDividerModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_32__["MatExpansionModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_33__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_34__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_35__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_36__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_37__["MatMenuModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_38__["MatNativeDateModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_39__["MatPaginatorModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_40__["MatProgressBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_41__["MatProgressSpinnerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_42__["MatRadioModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_38__["MatRippleModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_43__["MatSelectModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_44__["MatSidenavModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_45__["MatSliderModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_46__["MatSlideToggleModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_47__["MatSnackBarModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_48__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_49__["MatTableModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_50__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_51__["MatToolbarModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_52__["MatTooltipModule"], _angular_material_tree__WEBPACK_IMPORTED_MODULE_53__["MatTreeModule"], _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_54__["OverlayModule"], _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_15__["PortalModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_16__["ScrollingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_55__["IonicModule"].forRoot(), ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_10__["ModalModule"].forRoot(), ngx_bootstrap_collapse__WEBPACK_IMPORTED_MODULE_66__["CollapseModule"].forRoot()],
        exports: [_components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_3__["NotFoundComponent"], _components_spinner_component_spinner_component_component__WEBPACK_IMPORTED_MODULE_62__["SpinnerComponentComponent"], _login_signin_employer_signin_employer_signin_component__WEBPACK_IMPORTED_MODULE_2__["EmployerSigninComponent"], _components_view_profile_view_profile_component__WEBPACK_IMPORTED_MODULE_1__["ViewProfileComponent"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_41__["MatProgressSpinnerModule"], ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_59__["AlertModule"], ng_otp_input__WEBPACK_IMPORTED_MODULE_58__["NgOtpInputModule"], ngx_bootstrap_datepicker__WEBPACK_IMPORTED_MODULE_60__["BsDatepickerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_11__["FormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_12__["MatFormFieldModule"], _angular_cdk_clipboard__WEBPACK_IMPORTED_MODULE_13__["ClipboardModule"], _angular_cdk_stepper__WEBPACK_IMPORTED_MODULE_17__["CdkStepperModule"], _angular_cdk_table__WEBPACK_IMPORTED_MODULE_18__["CdkTableModule"], _angular_cdk_tree__WEBPACK_IMPORTED_MODULE_19__["CdkTreeModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_14__["DragDropModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_20__["MatAutocompleteModule"], _angular_material_badge__WEBPACK_IMPORTED_MODULE_21__["MatBadgeModule"], _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_22__["MatBottomSheetModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_23__["MatButtonModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_24__["MatButtonToggleModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_25__["MatCardModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_26__["MatCheckboxModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_27__["MatChipsModule"], _angular_material_stepper__WEBPACK_IMPORTED_MODULE_28__["MatStepperModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_29__["MatDatepickerModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_30__["MatDialogModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_31__["MatDividerModule"], _angular_material_expansion__WEBPACK_IMPORTED_MODULE_32__["MatExpansionModule"], _angular_material_grid_list__WEBPACK_IMPORTED_MODULE_33__["MatGridListModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_34__["MatIconModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_35__["MatInputModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_36__["MatListModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_37__["MatMenuModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_38__["MatNativeDateModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_39__["MatPaginatorModule"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_40__["MatProgressBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_41__["MatProgressSpinnerModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_42__["MatRadioModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_38__["MatRippleModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_43__["MatSelectModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_44__["MatSidenavModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_45__["MatSliderModule"], _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_46__["MatSlideToggleModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_47__["MatSnackBarModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_48__["MatSortModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_49__["MatTableModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_50__["MatTabsModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_51__["MatToolbarModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_52__["MatTooltipModule"], _angular_material_tree__WEBPACK_IMPORTED_MODULE_53__["MatTreeModule"], _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_54__["OverlayModule"], _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_15__["PortalModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_16__["ScrollingModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_55__["IonicModule"], ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_10__["ModalModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _components_add_job_post_job_details_job_details_component__WEBPACK_IMPORTED_MODULE_61__["JobDetailsComponent"], _components_all_job_posts_all_job_posts_component__WEBPACK_IMPORTED_MODULE_63__["AllJobPostsComponent"], _components_manage_applicants_manage_applicants_component__WEBPACK_IMPORTED_MODULE_5__["ManageApplicantsComponent"], _components_applications_applications_component__WEBPACK_IMPORTED_MODULE_4__["ApplicationsComponent"], _login_signin_signin_component__WEBPACK_IMPORTED_MODULE_64__["SigninComponent"], _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_65__["NgSelectModule"], ngx_bootstrap_collapse__WEBPACK_IMPORTED_MODULE_66__["CollapseModule"], _components_nav_bar_content_nav_bar_content_component__WEBPACK_IMPORTED_MODULE_67__["NavBarContentComponent"], _components_recent_jobs_recent_jobs_component__WEBPACK_IMPORTED_MODULE_68__["RecentJobsComponent"]],
        providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_57__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_56__["SplashScreen"], ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_10__["BsModalRef"]],
      ...
      var RecentJobsComponent = /*#__PURE__*/function () {
        ...
        _createClass(RecentJobsComponent, [{
          ...
          value: function getMyApplication() {
            ...
            this.authService.find(db).subscribe(function (data) {
              if (data.data) {
                _this23.allMyApplications = data.data;

                _this23.checkJobPosts();
              }
            });
          }
        }, {
          ...
          value: function checkJobPosts() {
            ...
            this.allJobPost.forEach(function (post) {
              if (_this24.allMyApplications.find(function (data) {
                return data.jobPostId === post._id;
              })) {
                post.isApplied = true;
              }
          ...
          value: function ngOnInit() {
            ...
            this.authService.find(db).subscribe(function (data) {
              if (data.data.length > 0) {
                _this25.filteredJobPosts = data.data;
                _this25.allJobPost = data.data;

                _this25.getMyApplication();
            ...
            this.authService.find(dbOpeartion).subscribe(function (data) {
              if (data.data.length > 0) {
                data.data.forEach(function (ele) {
                  _this25.allLocations.add(ele.jobPost.location);
                });
              }
            });
          }
          ...
          value: function filterJobPosts() {
            ...
            this.allJobPost.forEach(function (jobPost, index) {
              if (jobPost.jobPost.title.toLowerCase().includes(search)) {
                _this26.filteredJobPosts.push(JSON.stringify(jobPost));
              }
              ...
              if (_this26.allJobPost.length === index + 1) {
                var arr = _toConsumableArray(new Set(_this26.filteredJobPosts));

                _this26.filteredJobPosts = [];
                arr.forEach(function (data) {
                  _this26.filteredJobPosts.push(JSON.parse(data));
                });
              }
            });
          }
          ...
          value: function refineJobs() {
            ...
            this.authService.find(dbOpeartion).subscribe(function (data) {
              if (data.data) {
                _this27.filteredJobPosts = data.data;
                _this27.allJobPost = data.data;

                _this27.checkJobPosts();

                _this27.refineInitial.partTime = _this27.refine.partTime, _this27.refineInitial.fullTime = _this27.refine.fullTime, _this27.refineInitial.jobs = _this27.refine.jobs, _this27.refineInitial.internships = _this27.refine.internships, _this27.refineInitial.remote = _this27.refine.remote, _this27.refineInitial.minExp = _this27.refine.minExp, _this27.refineInitial.location = _this27.refine.location;

                if (!_this27.isScreenBig) {
                  _this27.refineJobsDropDown = false;
                }

                _this27.filterJobPosts();
    ...
    function VzVu(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-app style=\"overflow: auto; z-index: 999 !important; background-color: #f7f7f7;\" class=\"w-100 h-100\">\r\n  <ion-router-outlet></ion-router-outlet>\r\n</ion-app>\r\n\r\n\r\n";
      /***/
    },
    ...
    /***/
    function WTty(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_signin_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./signin.component.html */
      "uh5L");
      /* harmony import */


      var _signin_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var SigninComponent = /*#__PURE__*/function () {
        function SigninComponent(modalRef, authService, router, routing, toast, modalService, location) {
        ...
        _createClass(SigninComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.routing.params.subscribe(function (params) {
              if (params.user) {
                _this28.isServiceRunning = true;
                _this28.socialUser = params.user;
                var db = {
                  collection: 'users',
                  query: {
                    providerId: _this28.socialUser
                  }
                };

                _this28.authService.find(db).subscribe(function (data) {
                  if (data.data) {
                    if (data.data.length > 0) {
                    ...
                    _this28.toast.showToast('Something Went Wrong!', 'bg-danger');
          ...
          value: function resendOTP() {
            ...
            this.authService.getOTP({
              ...
              if (data.data === true) {
                _this30.toast.showToast('Passcode Sent Successfully!');
          ...
          value: function registrationVisible() {
            ...
            setTimeout(function () {
              ...
              _this31.initializeSignupForm();

              _this31.isRegistration = true;
            }, 300);
          }
        }, {
          key: "loginVisible",
          ...
          value: function registerCandidate() {
            ...
            if (this.signupForm.valid) {
              ...
              this.authService.registerCandidate(candidate).subscribe(function (data) {
                if (data.error) {
                  _this33.message = data.error;
                } else {
                  _this33.hideAll();

                  _this33.isVerifyOTP = true;
                  var counter = 30;
                  Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
                    return counter > 0;
                  }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function () {
                    ...
                    _this33.timer = counter;
                  });
                }

                _this33.isServiceRunning = false;
              });
            }
          }
        }, {
          ...
          value: function verifyOTP() {
            ...
            if (this.isForgotPassOTP) {
              ...
              this.authService.verify(data).subscribe(function (res) {
                if (res.data === true) {
                  _this34.isVerified = true;

                  _this34.hideAll();

                  _this34.isResetPassword = true;
                } else {
                  _this34.isOTPCorrect = false;
                }
              ...
              this.authService.verifyOTP(_data2).then(function (res) {
                if (res.data === true) {
                  _this34.isVerified = true;

                  _this34.hideAll();

                  _this34.loginVisible();
                } else {
                  _this34.isOTPCorrect = true;
                }
          ...
          value: function login() {
            ...
            if (this.loginForm.valid) {
              ...
              this.authService.login({
                ...
                if (data.error) {
                  _this35.message = 'Invalid email or password!';
                } else if (data.email) {
                  if (data.role === 2) {
                    ...
                    _this35.message = 'User not found!';
                  }
                }
          ...
          key: "linkedinLogin",
          value: function linkedinLogin() {
            window.open('https://instajobapp.herokuapp.com/linkedin', '_self'); // this.authService.linkedInLogin().subscribe(data => {
            // });
          }
        }, {
          key: "googleLogin",
          value: function googleLogin() {
            window.open('https://instajobapp.herokuapp.com/google', '_self'); // this.authService.linkedInLogin().subscribe(data => {
            // });
          }
        }, {
          key: "facebookLogin",
              ...
              this.authService.getOTP({
                ...
                if (data.data === true) {
                  ...
                  Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
                    ...
                    _this36.timer = counter;
                  });
                  _this36.isForgotPassOTP = true;
                }
            ...
            if (this.resetPassword.value) {
              ...
              this.authService.update(dbopeartion).then(function (data) {
                if (data.data === true) {
                  ...
                  _this37.toast.showToast('Password Reseted!');

                  _this37.isLogin = true;
          ...
          key: "openEmployerModal",
          value: function openEmployerModal() {
            var _this38 = this;

            this.isEmployer = true;
            setTimeout(function () {
              _this38.registrationVisible();
            }, 100); // this.modalRef.hide();
      ...
      SigninComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: 'app-signin',
    ...
    function YYSD(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "::ng-deep .mat-form-field-flex > .mat-form-field-infix {\n  padding: 0.9em 0px !important;\n}\n\n::ng-deep .mat-form-field-label-wrapper {\n  top: -1.3em;\n  font-size: 15px;\n}\n\n::ng-deep .mat-form-field-appearance-outline.mat-form-field-can-float.mat-form-field-should-float .mat-form-field-label {\n  transform: translateY(-1.1em) scale(0.75);\n}\n\n::ng-deep .cdk-overlay-container {\n  z-index: 1200 !important;\n}\n\n:root {\n  --progress-bar-width-my-profile: 0px;\n}\n\n::-moz-placeholder {\n  /* Chrome, Firefox, Opera, Safari 10.1+ */\n  opacity: 1;\n  /* Firefox */\n}\n\n::placeholder {\n  /* Chrome, Firefox, Opera, Safari 10.1+ */\n  opacity: 1;\n  /* Firefox */\n}\n\ninput::-webkit-input-placeholder {\n  color: #888 !important;\n}\n\ninput:focus::-webkit-input-placeholder {\n  color: #888 !important;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
      ...
      var LogInComponent = /*#__PURE__*/function () {
        ...
        _createClass(LogInComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.routing.params.subscribe(function (params) {
              if (params.user) {
                _this39.isServiceRunning = true;
                _this39.socialUser = params.user;
                var db = {
                  collection: 'users',
                  query: {
                    providerId: _this39.socialUser
                  }
                };

                _this39.authService.find(db).subscribe(function (data) {
                  if (data.data) {
                    if (data.data.length > 0) {
                      window.localStorage.setItem('id', window.btoa(JSON.stringify(data.data[0])));
                      window.location.reload();
                      _this39.isServiceRunning = false;
                    }
                  } else {
                    _this39.toast.showToast('Something Went Wrong!', 'bg-danger');
          ...
          value: function resendOTP() {
            ...
            this.authService.getOTP({
              ...
              if (data.data === true) {
                _this41.toast.showToast('Passcode Sent Successfully!');
                ...
                Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
                  ...
                  _this41.timer = counter;
                });
                _this41.isServiceRunning = false;
              }
            });
          }
        }, {
          ...
          value: function registrationVisible() {
            ...
            setTimeout(function () {
              ...
              _this42.initializeSignupForm();

              _this42.isRegistration = true;
            }, 300);
          }
        }, {
          key: "loginVisible",
          value: function loginVisible() {
            ...
            setTimeout(function () {
              ...
              _this43.isLogin = true;
              _this43.isLoginCard = true;
            }, 300);
          }
        }, {
          key: "showLogin",
          ...
          value: function registerCandidate() {
            ...
            if (this.signupForm.valid) {
              ...
              this.authService.registerCandidate(candidate).subscribe(function (data) {
                if (data.error) {
                  _this44.message = data.error;
                } else {
                  _this44.hideAll();

                  _this44.isVerifyOTP = true;
                  var counter = 30;
                  Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
                    return counter > 0;
                  }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function () {
                    ...
                    _this44.timer = counter;
                  });
                }

                _this44.isServiceRunning = false;
              });
            } else {
          ...
          value: function verifyOTP() {
            ...
            if (this.isForgotPassOTP) {
              ...
              this.authService.verify(data).subscribe(function (res) {
                if (res.data === true) {
                  _this45.isVerified = true;

                  _this45.hideAll();

                  _this45.isResetPassword = true;
                } else {
                  _this45.isOTPCorrect = false;
                }

                _this45.isServiceRunning = false;
              });
            } else {
              var _data3 = {
                email: this.signupForm.get('email').value,
              ...
              this.authService.verifyOTP(_data3).then(function (res) {
                if (res.data === true) {
                  _this45.isVerified = true;

                  _this45.hideAll();

                  _this45.isLogin = true;
                } else {
                  _this45.isOTPCorrect = false;
                }
          ...
          value: function login() {
            ...
            if (this.loginForm.valid) {
              ...
              this.authService.login({
                ...
                if (data.error) {
                  _this46.message = 'Invalid email or password!';
                } else if (data.email) {
                  ...
                  _this46.message = 'User not found!';
                }

                _this46.isServiceRunning = false;
              });
            }
          }
        }, {
              ...
              this.authService.getOTP({
                ...
                if (data.data === true) {
                  ...
                  Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
                    ...
                    _this47.timer = counter;
                  });
                  _this47.isForgotPassOTP = true;
                }
            ...
            if (this.resetPassword.value) {
              ...
              this.authService.update(dbopeartion).then(function (data) {
                if (data.data === true) {
                  ...
                  _this48.toast.showToast('Password Reseted!');

                  _this48.isLogin = true;
                  _this48.isServiceRunning = false;
                }
              });
            }
          }
    ...
    function eqfQ(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".sort-by-selected {\n  border: 1px solid #4b4b4b;\n  color: #4f0a8f;\n  background-color: #e9e9e9;\n}\n\n.sort-by-not-selected {\n  border: 1px solid #4b4b4b;\n  color: #4b4b4b;\n  background-color: white;\n}\n\n::ng-deep .mat-step-header .mat-step-icon-selected, .mat-step-header .mat-step-icon-state-done, .mat-step-header .mat-step-icon-state-edit {\n  background-color: red !important;\n}\n\n::ng-deep .mat-form-field-appearance-outline .mat-form-field-outline {\n  color: white !important;\n}\n\n::ng-deep .mat-form-field-appearance-outline.mat-focused .mat-form-field-outline-thick {\n  color: white !important;\n}\n\n::ng-deep .mat-form-field-appearance-outline.mat-form-field-invalid.mat-form-field-invalid .mat-form-field-outline-thick {\n  color: red !important;\n  opacity: 0.8 !important;\n}\n\n::ng-deep .mat-input-element {\n  caret-color: white !important;\n}\n\n::ng-deep .mat-form-field-invalid .mat-input-element, .mat-warn .mat-input-element {\n  caret-color: red !important;\n}\n\n::ng-deep .mat-form-field-label {\n  color: rgba(255, 255, 255, 0.6) !important;\n}\n\n::ng-deep .mat-form-field.mat-focused .mat-form-field-label {\n  color: white !important;\n}\n\n::ng-deep .mat-form-field.mat-form-field-invalid .mat-form-field-label {\n  color: white !important;\n}\n\n::-moz-placeholder {\n  /* Chrome, Firefox, Opera, Safari 10.1+ */\n  color: #a0a0a0;\n  opacity: 1;\n  /* Firefox */\n}\n\n::placeholder {\n  /* Chrome, Firefox, Opera, Safari 10.1+ */\n  color: #a0a0a0;\n  opacity: 1;\n  /* Firefox */\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
        ...
        _createClass(JobPostServiceService, [{
          ...
          value: function getMyApplications() {
            ...
            this.appliedJobPost({
              ...
              if (data.data) {
                _this49.myApplications.next(data.data);
              }
            });
          }
        }, {
            ...
            if (window.localStorage.getItem('id')) {
              if (JSON.parse(window.atob(window.localStorage.getItem('id'))).role === 1) {
                this.getJobPostsByEmployer({
                  ...
                  _this50.jobPosts.next(data.data);
                });
              } else {
      ...
      var ApplicationsComponent = /*#__PURE__*/function () {
        ...
        _createClass(ApplicationsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (params) {
              if (params.jobId) {
                _this51.postId = params.jobId;

                _this51.getDetails();

                _this51.allCandidates = [];

                _this51.getApplicants();

                _this51.getReferedProfiles();
              }
            });
            this.filteredSkills = this.skillName.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (value) {
              return _this51._filterSkills(value);
            }));
          }
        }, {
          key: "_filterSkills",
          ...
          value: function getApplicants() {
            ...
            this.dbService.find(db).subscribe(function (candidates) {
              _this52.isServiceRunning = false;

              if (candidates.data.length > 0) {
                candidates.data.forEach(function (cand, index) {
                  _this52.isServiceRunning = true;
                  var dbOperation = {
                    collection: 'users',
                    query: {
                  ...
                  _this52.dbService.find(dbOperation).subscribe(function (a) {
                    if (a.data.length > 0) {
                      a = a.data[0];
                      var user = {
                        applyId: cand._id,
                      ...
                      if (!_this52.allCandidates.find(function (data) {
                        return data._id === user._id;
                      })) {
                        _this52.allCandidates.push(user);
                      }

                      _this52.changeTopMenu(0);

                      _this52.calculateApplocants();
          ...
          value: function getDetails() {
            ...
            this.dbService.find(operation).subscribe(function (data) {
              _this53.isServiceRunning = false;

              if (data.data.length > 0) {
                _this53.isServiceRunning = true;
                _this53.post = data.data[0];
              }
            });
          }
        }, {
          ...
          value: function getReferedProfiles() {
            ...
            this.dbService.find(operation).subscribe(function (candidates) {
              _this54.isServiceRunning = false;

              if (candidates.data.length > 0) {
                candidates.data.forEach(function (cand, index) {
                  _this54.isServiceRunning = true;
                  var dbOperation = {
                    collection: 'users',
                    query: {
                      email: cand.email,
                  ...
                  _this54.dbService.find(dbOperation).subscribe(function (a) {
                    if (a.data.length > 0) {
                      a = a.data[0];
                      var user = {
                        applyId: cand._id,
                      ...
                      if (!_this54.allCandidates.find(function (data) {
                        return data.applyId === user.applyId;
                      })) {
                        _this54.allCandidates.push(user);
                      }

                      _this54.changeTopMenu(0);

                      _this54.calculateApplocants();
                    } else {
                      var _user = {
                        applyId: cand._id,
                        _id: cand._id,
                      ...
                      if (!_this54.allCandidates.find(function (data) {
                        ...
                        _this54.allCandidates.push(_user);
                      }
            ...
            this.candidatesArray.forEach(function (cand, index) {
              var dbOperation = {
                ...
                query: {
                  _id: cand.candidateId,
                  totalWorkExp: {
                    $gt: _this55.minExp ? _this55.minExp - 1 : 0
                  }
                }
              };
              _this55.allAplications = [];
              _this55.aplications = [];

              _this55.dbService.find(dbOperation).subscribe(function (user) {
                _this55.isServiceRunning = false;

                if (user.data.length > 0) {
                  var candidate = user.data[0];

                  if (_this55.skillsArray.length > 0) {
                    _this55.skillsArray.forEach(function (skill) {
                      if (candidate.skills.find(function (data) {
                        ...
                        _this55.aplications.push(localCandidate);

                        _this55.allAplications.push(localCandidate);
                      }
                    });
                  } else {
                    candidate.appliedOn = candidate.date;

                    _this55.allAplications.push(candidate);

                    _this55.aplications.push(candidate);
                  }
                }
              });

              if (index + 1 === _this55.candidatesArray.length) {
                _this55.closeModal();
              }
            });
          }
          ...
          value: function updateStatus(status) {
            ...
            this.filteredCandidates.forEach(function (user, index) {
              if (user.isChecked === true) {
                ...
                _this56.dbService.update(db).then(function (data) {
                  if (data.data === true) {
                    user.isChecked = false;
                    _this56.isServiceRunning = false;
                  } else {
                    _this56.toast.showToast('Something went wrong!', 'bg-danger');
                  }
                });
              }

              if (index === _this56.filteredCandidates.length - 1) {
                _this56.isServiceRunning = false;

                _this56.toast.showToast("".concat(status, " Successfully!"));

                _this56.getApplicants();

                _this56.getReferedProfiles();
              }
            });
          }
        }, {
          ...
          value: function checkAll() {
            ...
            this.filteredCandidates.map(function (cand) {
              cand.isChecked = _this57.isAllChecked;
            });
          }
        }, {
          key: "checkedUser",
      ...
      var JobDetailsComponent = /*#__PURE__*/function () {
        ...
        _createClass(JobDetailsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (params) {
              if (params.id) {
                _this58.jobPostService.myApplications.subscribe(function (data) {
                  data.forEach(function (post) {
                    if (post.jobPostId === params.id) {
                      _this58.appliedDate = post.date;
                    }
                  });
                });

                _this58.jobPostService.getJobPost({
                  id: params.id
                }).subscribe(function (data) {
                  _this58.jobPost = data.data;
                  _this58.isServiceRunning = false;
                  _this58.skills = _this58.jobPost.jobPost.skills;
                });
              }
            });
          }
          ...
          value: function applyJob() {
            ...
            this.jobPostService.applyJobPost(obj).subscribe(function (data) {
              if (data.data) {
                _this59.toastService.showToast('Applied successfully!');

                _this59.jobPostService.getMyApplications();
    ...
    /***/
    function uh5L(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _login_signin_signin_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./login/signin/signin.component */
      "WTty");
      /* harmony import */


      var _log_in_log_in_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./log-in/log-in.component */
      "br8r");
      /* harmony import */
