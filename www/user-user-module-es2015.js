...
const routes = [
    {
        path: '', component: _user_dashboard_user_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["UserDashboardComponent"], children: [
            ...
            {
                path: 'dashboard', component: _usermenu_usermenu_component__WEBPACK_IMPORTED_MODULE_11__["UsermenuComponent"]
            },
            {
                path: 'profile', component: _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_7__["UserProfileComponent"]
            },
            {
                path: 'organizations', component: _user_page_user_page_component__WEBPACK_IMPORTED_MODULE_10__["UserPageComponent"]
            },
            {
                path: 'jobs', component: _user_jobs_user_jobs_component__WEBPACK_IMPORTED_MODULE_9__["UserJobsComponent"]
            },
            {
                path: 'jobs/job-detail/:id', component: _job_detail_job_detail_component__WEBPACK_IMPORTED_MODULE_2__["JobDetailComponent"]
            },
            {
                path: 'my-applications', component: _my_applications_my_applications_component__WEBPACK_IMPORTED_MODULE_1__["MyApplicationsComponent"]
            },
            {
                path: 'referred', component: _refered_profiles_refered_profiles_component__WEBPACK_IMPORTED_MODULE_12__["ReferedProfilesComponent"]
            },
            {
                path: 'messages', component: _user_messages_user_messages_component__WEBPACK_IMPORTED_MODULE_8__["UserMessagesComponent"]
            },
        ]
    },
];
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.referJobPostForm.valid) {
                ...
                this.dbService.find(db).subscribe((data) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                    if (data.data.length === 0) {
                        const storageRef = firebase__WEBPACK_IMPORTED_MODULE_12__["storage"]().ref();
                        const time = new Date().getTime();
                        yield storageRef.child(`${this.basePath}/${this.referJobPostForm.get('name').value}${time}${this.filename}`).put(this.fileData);
                        storageRef.child(`${this.basePath}/${this.referJobPostForm.get('name').value}${time}${this.filename}`).getDownloadURL().then((url) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                            resume = url;
                            this.fileData = undefined;
...
let UserProfileComponent = class UserProfileComponent {
    ...
    uploadResume() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.isServiceRunning = true;
            const storageRef = firebase__WEBPACK_IMPORTED_MODULE_11__["storage"]().ref();
            const time = new Date().getTime();
